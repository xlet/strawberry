...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = FriendGroupMessage.class, name = "FriendGroup"),
        @JsonSubTypes.Type(value = RecentContactsMessage.class, name = "RecentContacts"),
        @JsonSubTypes.Type(value = OfflineMessage.class, name = "Offline"),
        //forward
